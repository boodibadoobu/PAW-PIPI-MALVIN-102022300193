...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($jurusan))) {
        ...
        $jurusanErr = "Masukkan hanya alphabet";
        } 
    }
    ...
    if (empty(trim($fakultas))) {
        $fakultasErr = "Fakultas perlu diisi";
    } else {
        if ( !preg_match ("/^[a-zA-Z\s]+$/",$fakultas)) {
        $fakultasErr = "Masukkan hanya alphabet";
        } 
    }
...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
            ...
            <input type="text" id="nim" name="nim" value="<?php echo $_POST['nim'] ?? ''; ?>">
            <span class="error"><?php echo $nimErr ? "* $nimErr" : ""; ?></span>
            </div>

            <div class="form-group">
            <label for="jurusan">Jurusan</label>
            <input type="text" id="jurusan" name="jurusan" value="<?php echo $_POST['jurusan'] ?? ''; ?>">
            <span class="error"><?php echo $jurusanErr ? "* $jurusanErr" : ""; ?></span>
            </div>

            <div class="form-group">
            <label for="fakultas">Fakultas</label>
            <input type="text" id="fakultas" name="fakultas" value="<?php echo $_POST['fakultas'] ?? ''; ?>">
