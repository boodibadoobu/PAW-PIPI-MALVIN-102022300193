                ...
                <div class="text-center text-lg-start">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-lg-start gap-4 fs-5 text-muted">
                        <div class="d-flex align-items-center">
                            ...
                            <!-- ==================6================== -->
                            <!-- Tampilkan Waktu -->
                            <span>Waktu akses: <strong class="text-dark"><?php echo e($waktuakses); ?></strong></span>
                        </div>
                        <div class="d-flex align-items-center">
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Data Akang\XAMPP\htdocs\TPMODUL3_MALVIN\resources\views/dashboard.blade.php ENDPATH**/ ?>